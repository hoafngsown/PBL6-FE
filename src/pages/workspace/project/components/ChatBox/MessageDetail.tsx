...
export const MessageDetail = (props: IPropsMessageDetail) => {
  ...
  // const checkIsNewMessages = (messageDate: string) => {
  //   const date = calculateDuration(
  //     new Date(currentAdmin.lastSeen),
            ...
            <div className="flex">
              ...
              <div className="w-[calc(100%-40px)]">
                ...
                <span className="ml-[0.25rem] text-[0.5rem] text-[#878687]">
                  {format(new Date(message.createdAt), "HH:mm")}{" "}
                  {/* {checkIsNewMessages(messageDetail.createdAt) && (
                    <span className="text-[red] ml-[1rem]">New</span>
                  )} */}
                </span>
